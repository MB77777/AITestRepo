package com.silkycoders1.jsystemssilkycodders1.agui.sdk.serialization;
...
import com.agui.core.event.ToolCallChunkEvent;
...
public abstract class AgUiEventSerializationMixin {

    @JsonIgnore
    public abstract Object getRawEvent();
}
